...
import com.app.igrow.databinding.FragmentProductSearchDetailBinding
import com.app.igrow.ui.diagnose.DiagnoseFragment

class ProductsSearchDetailFragment : BaseFragment<FragmentProductSearchDetailBinding>() {
    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentProductSearchDetailBinding
        get() = FragmentProductSearchDetailBinding::inflate
